...
public:
    ...
    const vector<KeyLine> mvKeyLines,mvKeyRightLines;
    const Mat mLineDescriptors,mLineRightDescriptors;
    vector<Vector3d> mvKeyLineFunctions,mvKeyLineRightFunctions;
