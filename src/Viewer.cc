...
void Viewer::Run()
{
    ...
    pangolin::Var<bool> menuShowKeyFrameLine("menu.KeyFrameLine",true,true);
    pangolin::Var<bool> menuReset("menu.Reset",false,false);
    // pangolin::Var<bool> menuView("menu.View",false,false);

    // pangolin::Var<bool> menuORB("menu.ORB", false, false); 
    // pangolin::Var<bool> menuSDC("menu.SDC", false, false);   
    // pangolin::Var<bool> menuAUTO("menu.AUTO", true, true); 
    ...
    while(1)
    {
        ...
        if(menuShowKeyFrameLine)
        mpMapDrawer->DrawKeyFramesLine(true);
        //绘制关键帧和共视图
        ...
        // if(menuAUTO)
        // ;
        // orbExtractor->selected=0;
        // if(menuORB)
        // orbExtractor->selected=1;
        // if(menuSDC)
        // orbExtractor->selected=2;
